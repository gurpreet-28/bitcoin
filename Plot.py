...
st.set_page_config(
    ...
    page_icon="https://cryptologos.cc/logos/bitcoin-btc-logo.png?v=032"
)

st.title("Bitcoin Predicted Price")
st.write("Welcome to our Bitcoin Price Prediction page, where we leverage advanced machine learning models to forecast future prices of Bitcoin. Utilizing historical data and sophisticated algorithms, we provide an interactive and visually engaging representation of predicted Bitcoin prices.")
